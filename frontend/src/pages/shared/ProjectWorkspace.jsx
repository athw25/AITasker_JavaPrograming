...
import { statusBadge, PROJECT_STATUS, MILESTONE_STATUS, DELIVERY_STATUS } from '../../utils/statusMaps';
...
export default function ProjectWorkspace() {
  ...
  const disputeMutation = useMutation({
    ...
    onSuccess: () => { toast.success('Đã gửi yêu cầu tranh chấp'); setDisputeOpen(false); setDisputeReason(''); queryClient.invalidateQueries({ queryKey: ['project', projectId] }); },
