...
//             .thenReturn(Arrays.asList(new Object[]{2L, 4.5}));
//         when(projectRepository.countTotalProjectsGroupByExpert())
//             .thenReturn(Arrays.asList(new Object[]{2L, 10L}));
//         when(projectRepository.countCompletedProjectsGroupByExpert())
//             .thenReturn(Arrays.asList(new Object[]{2L, 9L}));
//         when(portfolioRepository.getPortfolioCountsForExperts())
//             .thenReturn(Arrays.asList(new Object[]{2L, 3L}));
